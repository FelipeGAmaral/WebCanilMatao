...
<body class="cadastro" style="background-image:url(img/fundocanil.png); background-size:cover; backdrop-filter: blur(0px);">
...
<div class="container">
  <div class="colunmcontato" style="padding: 25px;">
    <div class="quadro-branco">
      <br><h2>Endereço</h2>
